...
app.layout = html.Div(className = 'container', children = [
    ...
    html.Div(className='row', children=[
        html.Div(className='col-12', children=[
            ...
            html.H6(children=['In 2019, the most vulnerable nation is Singapore. The least vulnerable is Malaysia.'], style={"text-align":"justify", "opacity":"80%"}),
            html.H6(children=['The least ready Nation in 2019 is Myanmar, with the most ready being Thailand.'], style={"text-align":"justify", "opacity":"80%"}),
